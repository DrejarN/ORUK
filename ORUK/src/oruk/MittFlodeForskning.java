 ...
 * @author Laptop
 */
public class MittFlodeForskning extends javax.swing.JFrame {

    /**
     * Creates new form MittFlode
     */
    public MittFlodeForskning() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MittFlodeForskning.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MittFlodeForskning().setVisible(true);
            }
        });
    }
